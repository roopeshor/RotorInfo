...
MainWindow::MainWindow(QWidget* parent) : QMainWindow(parent), ui(new Ui::MainWindow), isConnected(false) {
  ...
  setWindowTitle("Serial Port Reader"); // This is already in the .ui file, but can be kept here if needed
  resize(600, 400);                   // Also in the .ui file
  ui->statusbar->addWidget(new QLabel("Disconnected")); // Initialize status bar text
}
...
MainWindow::~MainWindow() {
  ...
  delete ui; // Don't forget to delete the UI object
}
